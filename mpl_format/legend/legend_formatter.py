...
class LegendFormatter(object):
    ...
    def remove_entries(self, indices: List[int]) -> 'LegendFormatter':
        ...
        N.B. this creates a new legend. May need to set the following properties manually afterwards as they cannot be
        automatically determined from the old legend:
        ['loc', 'markerfirst', 'fancybox', 'bbox_to_anchor' 'bbox_transform', 'handler_map']
